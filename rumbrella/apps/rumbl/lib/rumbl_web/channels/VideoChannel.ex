defmodule RumblWeb.VideoChannel do
  ...
  def join("videos:" <> video_id, params, socket) do
    ...
    video = Repo.get!(Accounts.Video, video_id)
  ...
  def handle_in("new_annotation", params, user, socket) do
    changeset =
      ...
      |> Rumbl.Accounts.Annotation.changeset(params)
  ...
  defp broadcast_annotation(socket, annotation) do
    ...
    rendered_ann =
      Phoenix.View.render(RumblWeb.AnnotationView, "annotation.json", %{
  ...
  defp compute_additional_info(ann, socket) do
    for result <- InfoSys.compute(ann.body, limit: 1, timeout: 10_000) do
      ...
      info_changeset =
        ...
        |> Rumbl.Accounts.Annotation.changeset(attrs)
